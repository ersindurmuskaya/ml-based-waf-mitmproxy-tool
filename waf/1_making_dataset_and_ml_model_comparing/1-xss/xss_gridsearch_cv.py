...
parametre_dagitimi ={
    "max_depth": range(1, 9),
    "min_samples_split": range(2, 102,20),
    "min_samples_leaf": range(2, 102,10),
}
from sklearn.model_selection import GridSearchCV
# GridSearchCV kullanarak optimum hiperparametreleri bulma
model = DecisionTreeClassifier(criterion='entropy')
grid_search = GridSearchCV(estimator=model, param_grid=parametre_dagitimi, 
                           cv=10, scoring='f1_micro',return_train_score=True)
